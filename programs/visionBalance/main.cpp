 ...
 *
 * \defgroup visionBalance visionBalance
 *
 * @brief Creates an instance of roboticslab::VisionBalance.
 *
 * @section colorRegionDetection_options VisionBalance options:
 *
...
int main(int argc, char** argv) {
    ...
    rf.setVerbose(true);
    rf.setDefaultContext("visionBalance");
    rf.setDefaultConfigFile("visionBalance.ini");
    rf.configure(argc, argv);

    roboticslab::VisionBalance mod;
    if(rf.check("help")) {
